...
(function() {
  ...
  module.exports = exports = function(options) {
    ...
    if ((_ref13 = options.snocketsPostProcess) == null) {
  ...
  ConnectAssets = (function() {
    ...
    function ConnectAssets(options) {
      ...
      this.snockets = new Snockets({
        ...
        snocketsPostProcess: this.options.snocketsPostProcess
      });
      this.cssSourceFiles = {};
      this.compiledCss = {};
      this.buildFilenames = {};
  ...
  exports.cssCompilers = cssCompilers = {
    styl: {
      ...
      compileSync: function(sourcePath, source) {
        ...
        libs.stylus(source, options).use(libs.bootstrap()).use(libs.nib()).use(libs.bootstrap()).use(libs.stylusExtends).set('compress', this.compress).set('include css', true).define('url', libs.stylus.url()).render(callback);
        return result;
      }
    },
    less: {
